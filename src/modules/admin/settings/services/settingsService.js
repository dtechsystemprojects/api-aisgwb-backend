...
let inMemorySettings = [
  { id: 'SET-1', displayName: 'Website Title', key: "setting('general.title')", type: 'text', group: 'General', value: 'Study Solution' },
  { id: 'SET-2', displayName: 'Website Logo', key: "setting('general.logo')", type: 'file', group: 'General', value: '/images/logo.png', previewUrl: '/images/logo.png' },
  { id: 'SET-3', displayName: 'Website Favicon', key: "setting('general.favicon')", type: 'file', group: 'General', value: '/images/logo-sm.png', previewUrl: '/images/logo-sm.png' },
  { id: 'SET-4', displayName: 'Support Email Address', key: "setting('general.support_email')", type: 'text', group: 'General', value: 'support@studysolution.com' },
  { id: 'SET-5', displayName: 'Maintenance Mode', key: "setting('general.maintenance')", type: 'switch', group: 'General', value: false },
  { id: 'SET-6', displayName: 'SEO Meta Description', key: "setting('seo.meta_description')", type: 'textarea', group: 'SEO', value: 'Study Solution - Premier Online Learning & Management Platform' },
  { id: 'SET-7', displayName: 'Google Analytics Property ID', key: "setting('seo.ga_tracking_id')", type: 'text', group: 'SEO', value: 'G-XXXXXXX101' },
  { id: 'SET-8', displayName: 'SMTP Mail Host', key: "setting('mail.smtp_host')", type: 'text', group: 'Email / SMTP', value: 'smtp.studysolution.com' },
];
